...
#ifdef __cplusplus
extern "C" {  // extern "C" means that the internal symbol names generated by the compiler use the C convention. 
			  // This allows you to call the corresponding C function from within a C++ file.
#endif
